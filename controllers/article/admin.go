...
func (this *AdminArticleController) AddArticle() {
	...
	var segmenter sego.Segmenter  
     segmenter.LoadDictionary("/home/zy/blog/controllers/admin/dictionary.txt")  
     ...
     output := sego.SegmentsToSlice(segments, false)
      var buf string
       ...
       log.Greenln("fencifencifenci\n\n\n") 
     log.Greenln(buf)
	id, err := AddArticle(title, buf, keywords, abstract, username)
	if nil == err {
		this.Data["json"] = map[string]interface{}{
			"result": true,
